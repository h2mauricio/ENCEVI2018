...
UsePackage('tidyverse')
=======
>>>>>>> db479b2007e1f0bbe41b05ead31869e51dce7c5d
=======
>>>>>>> db479b2007e1f0bbe41b05ead31869e51dce7c5d
>>>>>>> ecab22c2776bdc59d7057492520e5fd8f42398a3
...
```{r}
# get municipality codes ordered and cleaned, result is stored in 
# input folder, as INEGI_agem_short.csv
Source('municipality_codes_inegi.R')
```

```{r}
<<<<<<< HEAD
#importing data of municipalities from ENCEVI 2018
df.munic.ids <- read.csv("input/INEGI_agem_short.csv")
df.munic.ids <- subset( df.munic.ids, select = -X )
=======
#table(df.munic$agem)
df.munic$agem <- as.numeric(df.munic$agem)
df.agem.codes$agem <- as.numeric(df.agem.codes$agem)
=======
=======
>>>>>>> db479b2007e1f0bbe41b05ead31869e51dce7c5d
